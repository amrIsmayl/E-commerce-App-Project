...
export default function Shoes(props) {
  ...
  const [searhShoes, setSearhShoes] = useState([]);
  ...
  function searchByProducer(e) {
    ...
    for (let i = 0; i < allShoes.length; i++) {
      if (allShoes[i].name.toUpperCase().includes(term.toUpperCase()) === true && term) {
        searchResult.push(allShoes[i]);
      }
    }
    setSearhShoes(searchResult);
  }
    ...
    <>
      <div className=' row d-flex justify-content-center pt-5'>
        ...
        <div className=' col-md-5 pt-5'>
          <h2 className=' p-2 '>Shoes Department</h2>
